...
public class Prostor extends Observable{
    ...
    /**
     * Vrací textový řetězec, který popisuje věci, například:
     * "veci: vodka ".
     *
     * @return Popis názvů věcí
     */
     ...
     * "postavy: strom ".
     *
     * @return Popis názvů postav
     */
    private String popisPostav(){
         String vracenyText = "postavy:";
        for (String postava : postavy.keySet()) {
            vracenyText += " " + postava;
        }
        return vracenyText;
    }
    ...
    /**
     * vytvoření vlastního příkazu, který najde vec (dobře se používá například pro
     * aktuální prostor)
     * @return jméno veci
     */
    ...
    /**
     * vytvoření vlastního příkazu vlož postavu
     */
    ...
    /**
     * vytvoření vlastního příkazu, který najde postavu (dobře se používá například pro
     * aktuální prostor)
    ...
    /**
     * vytvoření vlastního příkazu odeber věc
     * @return odebere věc
     */
    public Vec odeberVec(String nazev){
     ...
     /**
     * vytvoření vlastního příkazu odeber postavu
